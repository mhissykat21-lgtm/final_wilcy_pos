...
//   H=revenue  I=total  J=customer  K=payment  L=date  M=time

var INVENTORY_HEADERS = ['id','name','sku','qty','origPrice','price','threshold'];
var SALES_HEADERS     = ['id','itemId','itemName','sku','qty','pricePerPc','origPrice','revenue','total','customer','payment','date','time'];
