...
async function processCartSale() {
  ...
  // Sync updated stock quantities one by one
...
async function clearSales() {
  ...
  // Only remove from the local in-memory view + localStorage.
  // We NEVER delete from Google Sheets — history must always be preserved.
